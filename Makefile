...
dev_prepare:
	...
	sleep 30
	mysql -u root -h 127.0.0.1 -P 3306  -ptest -e "drop database if not exists jenkins_integrator";
...
test:
	mysql -u root -h 127.0.0.1 -P 3306  -ptest -e "drop database if exists test_jenkins_integrator";
	mysql -u root -h 127.0.0.1 -P 3306  -ptest -e "create database if not exists test_jenkins_integrator DEFAULT CHARACTER SET utf8;"
